...
for(i in 1:reps){
  entropy_p_shan[[i]] <- exp(vegan::diversity(transformed_out$p[,i,-afulvaHits], index = "shannon"))
  entropy_p_simps[[i]] <- exp(vegan::diversity(transformed_out$p[,i,-afulvaHits], index = "simpson"))
}

save(entropy_p_shan, entropy_p_simps, t_newdat, file = "entropy_p_fungi_conservative.RData")
...
# }
# 
# save(entropy_p_shan, entropy_p_simps,t_newdat, file = "entropy_p_fungi.RData")


rm(list=ls())
load("./data/entropy_p_fungi_conservative.RData")
